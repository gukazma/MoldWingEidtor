...
void RenderEditor()
{
    ...
    // io.ConfigFlags |= ImGuiConfigFlags_ViewportsEnable; // 可选

    static bool show_demo = false;
    static bool show_layer_panel = true;
    static bool show_property_panel = true;
    ...
    if (show_layer_panel)
    {
        ...
        {
            ImGui::Text("Position: 1.0, 2.0, 3.0");
            ImGui::TreePop();
        }
    ...
    if (show_viewport)
    {
        ...
        ImGui::Text("Viewport - Render your 3D scene or image here");
        // 在此处绘制纹理或绑定 FBO
        // ImGui::Image(my_texture, viewport_size);
        ImGui::End();
    }


    ImGui::End(); // Editor 主窗口
}
// Main code
int main(int, char **)
{
